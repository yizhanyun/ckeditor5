...
The package provides a plugin for {@link module:link/linkimage~LinkImage linking images}. See the {@link features/image-linking Linking images} section in the {@link features/image feature guide}.
